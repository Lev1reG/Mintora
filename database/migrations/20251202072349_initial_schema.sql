...
-- Description: Create all 15 core tables for Mintora financial tracker
-- Generated from: database/database.dbml
-- Date: 2025-12-02
...
CREATE TABLE "whatsapp_clients" (
  ...
  CONSTRAINT fk_whatsapp_clients_user FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE
);
...
CREATE INDEX idx_whatsapp_clients_phone ON "whatsapp_clients" ("phone_number");
CREATE INDEX idx_whatsapp_clients_user_id ON "whatsapp_clients" ("user_id");
CREATE INDEX idx_whatsapp_clients_user_active ON "whatsapp_clients" ("user_id", "is_active");
...
CREATE TABLE "category_aliases" (
  ...
  CONSTRAINT fk_category_aliases_category FOREIGN KEY ("category_id") REFERENCES "categories" ("id") ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX idx_category_aliases_unique ON "category_aliases" ("category_id", "alias");
...
CREATE TABLE "payment_methods" (
  ...
  CONSTRAINT payment_methods_type_check CHECK (type IN ('cash', 'card', 'bank_transfer', 'digital_wallet', 'other'))
);
...
CREATE TABLE "transactions" (
  ...
  CONSTRAINT transactions_source_check CHECK (source IN ('whatsapp', 'web')),
...
CREATE INDEX idx_transactions_active ON "transactions" ("user_id", "transaction_date") WHERE deleted_at IS NULL;
...
CREATE TABLE "merchants" (
  ...
  CONSTRAINT fk_merchants_category FOREIGN KEY ("default_category_id") REFERENCES "categories" ("id") ON DELETE SET NULL
);
...
CREATE INDEX idx_merchants_user_name ON "merchants" ("user_id", "name");
...
CREATE TABLE "whatsapp_conversations" (
  ...
  CONSTRAINT fk_whatsapp_conversations_user FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE,
  CONSTRAINT fk_whatsapp_conversations_client FOREIGN KEY ("whatsapp_client_id") REFERENCES "whatsapp_clients" ("id") ON DELETE CASCADE,
  CONSTRAINT fk_whatsapp_conversations_transaction FOREIGN KEY ("transaction_id") REFERENCES "transactions" ("id") ON DELETE SET NULL,
  CONSTRAINT whatsapp_conversations_direction_check CHECK (direction IN ('inbound', 'outbound')),
  CONSTRAINT whatsapp_conversations_confidence_check CHECK (confidence_score >= 0 AND confidence_score <= 1)
);
...
CREATE INDEX idx_whatsapp_conversations_user_created ON "whatsapp_conversations" ("user_id", "created_at");
CREATE INDEX idx_whatsapp_conversations_transaction ON "whatsapp_conversations" ("transaction_id");
CREATE INDEX idx_whatsapp_conversations_client ON "whatsapp_conversations" ("whatsapp_client_id");
CREATE INDEX idx_whatsapp_conversations_intent ON "whatsapp_conversations" ("intent");
